...
const double DX = 1E-6; //1E-4;         // Cell Spacing 
...
const int NUM_IONS = 50000;   //30000;      // Number of simulation ions
const int NUM_ELECTRONS = 100000; //80000; // Number of simulation electrons
const int NC =  800; //400;             // Total number of cells
